        ...
        <div className="min-h-[80vh] flex items-center justify-center">
            <div className="relative w-full max-w-sm mx-auto p-8">
                ...
                <div className="text-center mb-8 space-y-2">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">Join the elite KEC student freelancer network.</p>
                </div>
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                    <div className="space-y-1.5">
                        <label className="text-[10px] uppercase tracking-wider font-semibold text-zinc-500 dark:text-zinc-400 ml-1">Full Name</label>
                        <input
                            type="text"
                            value={name}
                    ...
                    <Button
                        variant="primary"
                        size="md"
                        className="w-full py-2.5 mt-2 shadow-emerald-500/20"
                        disabled={loading}
                    >
