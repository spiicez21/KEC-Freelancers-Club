        ...
        <div className="space-y-6 md:space-y-12">
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="text-zinc-500 font-display font-medium tracking-widest uppercase text-[10px]">Loading amazing talent...</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {members.length === 0 && !error && (
                        <div className="col-span-full py-20 text-center">
                            <p className="text-zinc-500 font-display font-medium tracking-widest uppercase text-[10px]">No approved members yet.</p>
                        </div>
                    )}
                </div>
            )}
